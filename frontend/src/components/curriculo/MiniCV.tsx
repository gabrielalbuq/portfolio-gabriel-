		...
		<div className="flex-1 flex flex-col-reverse gap-6 md:flex-row lg:flex-col-reverse xl:flex-row items-center md:items-start lg:items-center xl:items-start bg-black border border-zinc-800 rounded-2xl px-6 pt-6">
			...
			<div className="flex flex-col gap-5 self-center py-6 items-center  md:items-start lg:items-center xl:items-start">
				...
				<p className="text-sm text-center md:text-left lg:text-center xl:text-left">
					Atualmente estou cursando Ciência da Computação na Universidade Estadual do Ceará (UECE), possuo 
					experiência prática no desenvolvimento de projetos de desenvolvimento web, demonstrando habilidades 
					em tecnologias modernas e metodologias ágeis. Atualmente, atuo como estagiário de TI, onde aprimoro 
					minhas competências técnicas e contribuo para soluções inovadoras dentro da área. Sou motivado por 
					desafios e tenho um interesse constante em aprender e aplicar novos conhecimentos no campo da 
					tecnologia.
				</p>
			</div>
		</div>
